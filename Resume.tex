...
%				{Game Engine}
%				{}
%				{Make a bare bones engine written in \CC using the SFML library. It is built using the Entity Component System design pattern, and includes features such as: logging, animation, asset handiling, //TODO}
%		\end{entrylist}
%		\begin{entrylist}
%			\entry
%				{\vphantom{1.0}}
%				{java API}
%				{}
%				{Written in Java with a MongoDB database, i made this to learn a noSQL database, and refresh my java programming.}
%		\end{entrylist}
		\cvsect{Hobbies}
		\begin{entrylist}
			\entry
